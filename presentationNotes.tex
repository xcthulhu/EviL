...
\begin{itemizedot}
  ...
  \begin{figure}[h]
    FIXME Picture of Thermometer in a Box
...
\tmtextsc{EviL} is \tmtextit{not normal}; it is not closed under replacement
of proposition letters with arbitrary formulae. \ Hence the axioms of
\tmtextsc{EviL} are schematic:
...
\tmtextsc{EviL} is closed under modus ponens, and Necessitation for $\Box $,
$\boxminus$ and $\boxplus$



\tmtextsc{EviL} Soundness and Weak Completeness
...
%%% Local Variables: 
%%% mode: latex
%%% TeX-master: "presentation/beamer"
%%% End: 
