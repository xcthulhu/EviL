...
grammar restriction suggested in \S\ref{sketch}.  %Since the original
                                %semantics offered in \S\ref{sketch}
                                %were subject to paradox, it will be
                                %of central importance to give an
                                %account of \textsc{EviL} that is not
                                %subject to paradox.

% I mentioned that the semantics previously developed in \S\ref{sketch} gave rise to a paradox.  
