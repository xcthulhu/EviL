...
\tmtextsc{EviL} models.  On the other hand, 
\tmtextsc{EviL} models can be understood as
...
R^{\Omega}_X$ and 
\newline $R^{\Omega}_X \subseteq (R^{\Omega}_X \circ
\sqsupseteq^{\Omega}_X)$ ]{
...
\subfigure[\ --\ \ref{pVI}\ --\ \newline 
 ...
 R^{\Omega}_X$ 
and \newline
 $R^{\Omega}_X \subseteq (\sqsupseteq^{\Omega}_Y \circ R^{\Omega}_X)$
]{
...
\begin{theorem}[Failure of Compactness]If the set of proposition
