...
(\refstepcounter{rownum}\arabic{rownum})\label{soundnessax} & $\vdash \PP_X \to \Nec_X \phi \to \phi$ & If $X$'s premises are sound, then her logical conclusion are correct \\[6pt]
