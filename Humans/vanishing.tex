In section \S\ref{validities}, we saw some of the structural validities of
\text{EviL} from a philosophical perspective.  That being the case,
...
Next, consider two sublanguages of the main language of \tmtextsc{EviL}:
